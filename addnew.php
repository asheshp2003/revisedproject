...
<head>
    ...
    <script>
        ...
        function validateForm() {
            ...
            const venueNamePattern = /^[a-zA-Z0-9\s\-,&']+$/; // Allows letters, numbers, spaces, hyphens, commas, ampersands, and apostrophes.
...
// to check if the user is logged in and is an admin
if (!isset($_SESSION['customer_id']) || $_SESSION['role'] !== 'admin') {
    header('Location: signin.php');
    exit;
}
...
//it is the function to sanitize inputs to avoid SQL injection
        ...
        <table>
            ...
            ?>
                    <tr>
                        ...
                        <td>
                            <a href="approve.php?booking_id=<?php echo urlencode($row['booking_id']); ?>">Approve</a> 
                            <a href="delete.php?booking_id=<?php echo urlencode($row['booking_id']); ?>" onclick="return confirm('Are you sure you want to delete this data?')">Delete</a>
                            <a href="decline.php?booking_id=<?php echo urlencode($row['booking_id']); ?>" onclick="return confirm('Are you sure you want to decline this booking?')">Decline</a>
                        </td>
                    </tr>
            <?php
                }
            ...
            <tbody>
                ...
                if (!$result) {
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($venue['description']); ?></td>
                        <td><img src="<?php echo htmlspecialchars($venue['image_path']); ?>" alt="Venue Image" style="width:100px; height:auto;"></td>
                        <td>
                            <a href="edit_venue.php?id=<?php echo urlencode($venue['id']); ?>">Edit</a>
                            <a href="delete_venue.php?id=<?php echo urlencode($venue['id']); ?>" onclick="return confirm('Are you sure you want to delete this venue?');">Delete</a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                <?php } ?>
